            ...
            process.stdout.on('data', (data) => {
                ...
                try {
                    ...
                    if (dataStr.includes(actionBeginTag) && dataStr.includes(actionEndTag)) {
                        ...
                        new obsidian.Notice(notificationText);
                    }
                    else {
