...
export default {
  ...
  SETTINGS_FOLDER_DESC:
    'Njia ya folda iliyo na hati zako za Python (kamili au inayohusiana na vault).',
  ...
  NOTICE_REQUESTS_MISSING_DESC_PREFIX:
    "Maktaba ya Python inayohitajika 'requests' haijasakinishwa kwa",
  ...
  NOTICE_INVALID_PORT_CONFIG_SUFFIX:
    'Seva haikuanzishwa. Tafadhali unda lango halali (1-65535) katika mipangilio.',
  ...
  NOTICE_PYTHON_EXEC_NOT_FOUND_PREFIX:
    'Haikuweza kupata faili tekelezi halali ya Python. Imejaribu:',
  NOTICE_PYTHON_EXEC_NOT_FOUND_SUFFIX:
    "Tafadhali hakikisha Python imesakinishwa na inapatikana kupitia PATH ya mfumo wako (au kizindua 'py' kwenye Windows).",
  ...
  SETTINGS_REFRESH_DEFINITIONS_BUTTON_DESC:
    'Changanua tena folda ya hati ili kugundua au kusasisha mipangilio iliyofafanuliwa ndani ya hati zako za Python.',
  ...
  SETTINGS_SCRIPT_FOLDER_NOT_CONFIGURED:
    'Folda ya hati za Python haijaundwa. Tafadhali weka njia hapo juu.',
  SETTINGS_NO_SCRIPT_SETTINGS_FOUND:
    "Hakuna hati zilizo na mipangilio inayoweza kufafanuliwa zilizopatikana kwenye folda iliyoundwa, au ugunduzi wa mipangilio umeshindwa. Bofya 'Onyesha Upya Ufafanuzi' ili kujaribu tena.",
  ...
  NOTICE_INVALID_FOLDER_PATH:
    'Njia batili ya folda. Tafadhali chagua folda halali katika mipangilio.',
  NOTICE_INVALID_STARTUP_FOLDER_PATH:
    "Njia ya folda ya hati za Python iliyosanidiwa '{path}' si sahihi au haipatikani. Inafuta mpangilio.",
  ...
  SETTINGS_SCRIPT_AUTOSTART_TOGGLE_DESC:
    "Endesha hati hii kiotomatiki wakati Obsidian inapoanza (tu ikiwa 'Hati Imewashwa' pia imewashwa).",
  SETTINGS_SCRIPT_AUTOSTART_DELAY_NAME: 'Kuchelewa Kuanza (sekunde)',
  SETTINGS_SCRIPT_AUTOSTART_DELAY_DESC:
    "Subiri sekunde hizi nyingi baada ya Obsidian kuanza kabla ya kuendesha hati (inatumika tu ikiwa 'Endesha Wakati wa Kuanza' imewashwa). Tumia 0 bila kuchelewa.",

  SETTINGS_AUTO_PYTHONPATH_NAME: 'Weka PYTHONPATH kiotomatiki kwa Maktaba',
  SETTINGS_AUTO_PYTHONPATH_DESC:
    'Ongeza kiotomatiki saraka ya programu-jalizi kwenye PYTHONPATH wakati wa kuendesha hati, kuruhusu uagizaji wa moja kwa moja wa maktaba ya Python (Inapendekezwa). Ikiwa imezimwa, lazima unakili ObsidianPluginDevPythonToJS.py kwenye folda yako ya hati au udhibiti sys.path mwenyewe.',
