...
export default {
  ...
  NOTICE_INVALID_PORT_CONFIG_SUFFIX:
    'Servidor não iniciado. Configure uma porta válida (1-65535) nas configurações.',
  ...
  NOTICE_PYTHON_EXEC_NOT_FOUND_PREFIX:
    'Não foi possível encontrar um executável Python válido. Tentativas:',
  NOTICE_PYTHON_EXEC_NOT_FOUND_SUFFIX:
    "Certifique-se de que o Python está instalado e acessível através do PATH do seu sistema (ou o lançador 'py' no Windows).",
  ...
  SETTINGS_REFRESH_DEFINITIONS_BUTTON_DESC:
    'Verifique novamente a pasta de scripts para descobrir ou atualizar as configurações definidas em seus scripts Python.',
  ...
  SETTINGS_SCRIPT_FOLDER_NOT_CONFIGURED:
    'A pasta de scripts Python não está configurada. Por favor, defina o caminho acima.',
  SETTINGS_NO_SCRIPT_SETTINGS_FOUND:
    "Nenhum script com configurações definíveis encontrado na pasta configurada, ou a descoberta de configurações falhou. Clique em 'Atualizar Definições' para tentar novamente.",
  ...
  NOTICE_INVALID_FOLDER_PATH:
    'Caminho da pasta inválido. Selecione uma pasta válida nas configurações.',
  NOTICE_INVALID_STARTUP_FOLDER_PATH:
    "O caminho da pasta de scripts Python configurado '{path}' é inválido ou não foi encontrado. Limpando a configuração.",

  SETTINGS_SCRIPT_ACTIVATE_TOGGLE_NAME: 'Script Ativado',
  SETTINGS_SCRIPT_ACTIVATE_TOGGLE_DESC:
    "Permitir que este script seja executado via comandos, atalhos ou 'Executar Todos'.",
  NOTICE_SCRIPT_DISABLED:
    "O script '{scriptName}' está desativado nas configurações e não pode ser executado.",

  SETTINGS_SCRIPT_AUTOSTART_TOGGLE_NAME: 'Executar ao Iniciar',
  SETTINGS_SCRIPT_AUTOSTART_TOGGLE_DESC:
    "Executar este script automaticamente quando o Obsidian iniciar (apenas se 'Script Ativado' também estiver ligado).",
  ...
  NOTICE_AUTO_PYTHONPATH_DISABLED_DESC:
    'PYTHONPATH automático desativado. Certifique-se de que ObsidianPluginDevPythonToJS.py está na sua pasta de scripts ou gerencie sys.path manually.',
  ...
  ACTIVATION_WARNING_MESSAGE:
    'Você está prestes a ativar o script Python "{scriptName}".',
  ACTIVATION_WARNING_RISK_FILES: 'Acessar e modificar arquivos no seu sistema',
  ACTIVATION_WARNING_RISK_NETWORK:
    'Fazer solicitações de rede para serviços externos',
  ACTIVATION_WARNING_RISK_SYSTEM:
    'Executar comandos do sistema e acessar recursos do sistema',
  ACTIVATION_WARNING_SECURITY_NOTE:
    'Ative apenas scripts de fontes em que você confia. O autor do plugin não é responsável por qualquer dano causado por scripts maliciosos.',
  ACTIVATION_WARNING_READMORE: 'Leia mais sobre considerações de segurança',
  ACTIVATION_WARNING_CANCEL: 'Cancelar',
  ACTIVATION_WARNING_ACTIVATE_ANYWAY: 'Ativar Mesmo Assim',
};
