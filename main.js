...
class ObsidianPythonBridge extends obsidian.Plugin {
    constructor() {
        super(...arguments);
        this.server = null;
        this.initialSocketPath = ''; // Adding the initialSocketPath property
    }
    onload() {
            ...
            connection.on('data', (data) => __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    if (action === 'get_all_note_paths') {
                        ...
                        try {
                            const noteContent = yield this.getActiveNoteContent();
                        ...
                        try {
                            yield this.modifyNoteContent(notePath, newContent);
                        ...
                        const userInput = yield this.requestUserInput(scriptName, inputType, message, validationRegex, minValue, // Now a number
    ...
    modifyNoteContent(notePath, content) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    showNotification(notificationText) {
        new obsidian.Notice(notificationText); // Affiche la notification avec le texte reçu
    }
    // Function to run a Python script
    runPythonScript(scriptPath) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.settings.socketPath !== this.initialSocketPath) {
                new obsidian.Notice("⚠️ Warning: The socket path has been changed. Please restart Obsidian to avoid malfunctions during script execution.");
            }
