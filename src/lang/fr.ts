...
export default {
  ...
  NOTICE_INVALID_PORT_CONFIG_SUFFIX:
    'Serveur non démarré. Veuillez configurer un port valide (1-65535) dans les réglages.',
  ...
  SETTINGS_SCRIPT_FOLDER_NOT_CONFIGURED:
    'Dossier des scripts Python non configuré. Veuillez définir le chemin ci-dessus.',
  SETTINGS_NO_SCRIPT_SETTINGS_FOUND:
    "Aucun script avec des paramètres définissables trouvé dans le dossier configuré, ou la découverte a échoué. Cliquez sur 'Rafraîchir les Définitions' pour réessayer.",
  ...
  NOTICE_PYTHON_EXEC_MISSING_FOR_REFRESH:
    'Impossible de rafraîchir : Exécutable Python introuvable. Assurez-vous que Python est installé et dans le PATH.',
  NOTICE_REFRESHING_SCRIPT_SETTINGS:
    'Rafraîchissement des définitions de paramètres des scripts...',
  NOTICE_REFRESH_SCRIPT_SETTINGS_SUCCESS:
    'Définitions des paramètres des scripts rafraîchies avec succès !',
  ...
  NOTICE_INVALID_FOLDER_PATH:
    'Chemin de dossier invalide. Veuillez sélectionner un dossier valide dans les réglages.',
  NOTICE_INVALID_STARTUP_FOLDER_PATH:
    "Le chemin configuré pour le dossier des scripts Python '{path}' est invalide ou introuvable. Effacement du réglage.",

  SETTINGS_SCRIPT_ACTIVATE_TOGGLE_NAME: 'Script Activé',
  SETTINGS_SCRIPT_ACTIVATE_TOGGLE_DESC:
    "Permet l'exécution de ce script via les commandes, les raccourcis ou 'Exécuter Tout'.",
  SETTINGS_SCRIPT_AUTOSTART_TOGGLE_NAME: 'Exécuter au Démarrage',
  SETTINGS_SCRIPT_AUTOSTART_TOGGLE_DESC:
    "Exécute automatiquement ce script au démarrage d'Obsidian (seulement si 'Script Activé' est aussi coché).",
  SETTINGS_SCRIPT_AUTOSTART_DELAY_NAME: 'Délai au Démarrage (secondes)',
  SETTINGS_SCRIPT_AUTOSTART_DELAY_DESC:
    "Attendre ce nombre de secondes après le démarrage d'Obsidian avant d'exécuter le script (s'applique seulement si 'Exécuter au Démarrage' est coché). Utilisez 0 pour aucun délai.",
  NOTICE_SCRIPT_DISABLED:
    "Le script '{scriptName}' est désactivé dans les paramètres et ne peut pas être exécuté.",

  // --- ADDED KEYS AT THE END ---
  SETTINGS_AUTO_PYTHONPATH_NAME: 'Définir PYTHONPATH pour la Librairie',
  SETTINGS_AUTO_PYTHONPATH_DESC:
    "Ajouter automatiquement le dossier du plugin à PYTHONPATH lors de l'exécution des scripts, permettant l'import direct de la librairie Python (Recommandé). Si désactivé, vous devez copier ObsidianPluginDevPythonToJS.py dans votre dossier de scripts ou gérer sys.path manuellement.",
  NOTICE_AUTO_PYTHONPATH_DISABLED_DESC:
    'PYTHONPATH automatique désactivé. Assurez-vous que ObsidianPluginDevPythonToJS.py est dans votre dossier de scripts ou gérez sys.path manuellement.',
