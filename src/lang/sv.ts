...
export default {
  ...
  NOTICE_REQUESTS_MISSING_DESC_PREFIX:
    "Det nödvändiga Python-biblioteket 'requests' är inte installerat för",
  ...
  NOTICE_INVALID_PORT_CONFIG_SUFFIX:
    'Servern startades inte. Konfigurera en giltig port (1-65535) i inställningarna.',
  ...
  NOTICE_PYTHON_EXEC_NOT_FOUND_PREFIX:
    'Kunde inte hitta en giltig Python-exekverbar fil. Försökte:',
  ...
  SETTINGS_REFRESH_DEFINITIONS_BUTTON_DESC:
    'Skanna om skriptmappen för att upptäcka eller uppdatera inställningar som definierats i dina Python-skript.',
  ...
  SETTINGS_SCRIPT_FOLDER_NOT_CONFIGURED:
    'Mappen för Python-skript är inte konfigurerad. Ange sökvägen ovan.',
  SETTINGS_NO_SCRIPT_SETTINGS_FOUND:
    "Inga skript med definierbara inställningar hittades i den konfigurerade mappen, eller så misslyckades inställningsupptäckten. Klicka på 'Uppdatera definitioner' för att försöka igen.",
  ...
  SETTINGS_LANGUAGE_DESC:
    "Välj visningsspråk för Python Bridge-pluginets gränssnitt. 'Automatisk' följer Obsidians språkinställning.",
  ...
  SETTINGS_SCRIPT_ACTIVATE_TOGGLE_DESC:
    "Tillåt att detta skript körs via kommandon, genvägar eller 'Kör alla'.",
  NOTICE_SCRIPT_DISABLED:
    "Skriptet '{scriptName}' är inaktiverat i inställningarna och kan inte köras.",

  SETTINGS_SCRIPT_AUTOSTART_TOGGLE_NAME: 'Kör vid start',
  SETTINGS_SCRIPT_AUTOSTART_TOGGLE_DESC:
    "Kör detta skript automatiskt när Obsidian startar (endast om 'Skript aktiverat' också är på).",
  ...
  NOTICE_AUTO_PYTHONPATH_DISABLED_DESC:
    'Automatisk PYTHONPATH inaktiverad. Se till att ObsidianPluginDevPythonToJS.py finns i din skriptmapp eller hantera sys.path manuellt.',
