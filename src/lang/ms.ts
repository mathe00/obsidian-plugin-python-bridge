...
export default {
  ...
  SETTINGS_FOLDER_DESC:
    'Laluan ke folder yang mengandungi skrip Python anda (mutlak atau relatif kepada vault).',
  ...
  NOTICE_PORT_MISMATCH_WARNING_SUFFIX:
    '). Skrip mungkin menyasarkan port lama jika sudah berjalan atau dilancarkan secara luaran.',
  ...
  NOTICE_PYTHON_EXEC_NOT_FOUND_PREFIX:
    'Tidak dapat mencari fail boleh laku Python yang sah. Mencuba:',
  NOTICE_PYTHON_EXEC_NOT_FOUND_SUFFIX:
    "Sila pastikan Python dipasang dan boleh diakses melalui PATH sistem anda (atau pelancar 'py' pada Windows).",
  ...
  SETTINGS_REFRESH_DEFINITIONS_BUTTON_DESC:
    'Imbas semula folder skrip untuk menemui atau mengemas kini tetapan yang ditentukan dalam skrip Python anda.',
  ...
  SETTINGS_SCRIPT_FOLDER_NOT_CONFIGURED:
    'Folder skrip Python tidak dikonfigurasikan. Sila tetapkan laluan di atas.',
  SETTINGS_NO_SCRIPT_SETTINGS_FOUND:
    "Tiada skrip dengan tetapan yang boleh ditentukan ditemui dalam folder yang dikonfigurasikan, atau penemuan tetapan gagal. Klik 'Segarkan Semula Definisi' untuk mencuba lagi.",
  ...
  SETTINGS_SCRIPT_ACTIVATE_TOGGLE_DESC:
    "Benarkan skrip ini dilaksanakan melalui arahan, pintasan atau 'Jalankan Semua'.",
  NOTICE_SCRIPT_DISABLED:
    "Skrip '{scriptName}' dilumpuhkan dalam tetapan dan tidak boleh dilaksanakan.",

  SETTINGS_SCRIPT_AUTOSTART_TOGGLE_NAME: 'Jalankan semasa Permulaan',
  SETTINGS_SCRIPT_AUTOSTART_TOGGLE_DESC:
    "Jalankan skrip ini secara automatik apabila Obsidian dimulakan (hanya jika 'Skrip Didayakan' juga dihidupkan).",
  ...
  NOTICE_AUTO_PYTHONPATH_DISABLED_DESC:
    'PYTHONPATH automatik dilumpuhkan. Pastikan ObsidianPluginDevPythonToJS.py berada dalam folder skrip anda atau urus sys.path secara manual.',
  ...
  NOTICE_PYTHON_EXEC_PATH_INVALID_NO_FALLBACK:
    'Laluan Python tersuai tidak sah, dan tiada boleh laksana sandaran ditemui. Skrip mungkin tidak berjalan.',
