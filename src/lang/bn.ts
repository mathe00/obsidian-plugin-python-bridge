...
export default {
  ...
  SETTINGS_CACHE_DESC:
    '.pyc ফাইল লেখা প্রতিরোধ করতে "-B" ফ্ল্যাগ দিয়ে পাইথন চালান।',
  ...
  NOTICE_REQUESTS_MISSING_DESC_PREFIX:
    "প্রয়োজনীয় পাইথন লাইব্রেরি 'requests' ইনস্টল করা নেই",
  ...
  NOTICE_INVALID_PORT_RANGE:
    'অবৈধ পোর্ট। অনুগ্রহ করে 0 এবং 65535 এর মধ্যে একটি সংখ্যা লিখুন।',
  NOTICE_PORT_MISMATCH_WARNING_PREFIX:
    '⚠️ পাইথন ব্রিজ: HTTP পোর্ট পরিবর্তিত হয়েছে (',
  ...
  NOTICE_SCRIPT_NOT_FOUND_PREFIX:
    'পাইথন স্ক্রিপ্ট পাওয়া যায়নি বা এটি একটি ফাইল নয়:',
  NOTICE_SCRIPT_ACCESS_ERROR_PREFIX:
    'স্ক্রিপ্ট ফাইল অ্যাক্সেস করার সময় ত্রুটি:',
  ...
  NOTICE_SCRIPTS_FOLDER_READ_ERROR_PREFIX:
    'স্ক্রিপ্ট ফোল্ডার পড়ার সময় ত্রুটি:',
  NOTICE_NO_SCRIPTS_FOUND:
    'কনফিগার করা ফোল্ডারে কোনো পাইথন স্ক্রিপ্ট (.py) পাওয়া যায়নি।',
  ...
  MODAL_SELECT_SCRIPT_PLACEHOLDER:
    'চালানোর জন্য একটি পাইথন স্ক্রিপ্ট নির্বাচন করুন...',
  ...
  NOTICE_REFRESHING_SCRIPT_SETTINGS:
    'স্ক্রিপ্ট সেটিংস সংজ্ঞা রিফ্রেশ করা হচ্ছে...',
  NOTICE_REFRESH_SCRIPT_SETTINGS_SUCCESS:
    'স্ক্রিপ্ট সেটিংস সংজ্ঞা সফলভাবে রিফ্রেশ করা হয়েছে!',
  ...
  CMD_REFRESH_SCRIPT_SETTINGS_NAME:
    'পাইথন স্ক্রিপ্ট সেটিংস সংজ্ঞা রিফ্রেশ করুন',
  ...
  SETTINGS_BACKLINK_CACHE_RECOMMENDATION_TITLE:
    'পারফরম্যান্স টিপ: ব্যাকলিঙ্ক ক্যাশে',
  ...
  NOTICE_SCRIPT_DISABLED:
    "স্ক্রিপ্ট '{scriptName}' সেটিংসে নিষ্ক্রিয় করা আছে এবং চালানো যাবে না।",
  ...
  SETTINGS_AUTO_PYTHONPATH_NAME:
    'লাইব্রেরির জন্য স্বয়ংক্রিয়ভাবে PYTHONPATH সেট করুন',
  ...
  SETTINGS_PYTHON_EXEC_PATH_PLACEHOLDER:
    'যেমন, /usr/bin/python3 অথবা C:Python39python.exe',
