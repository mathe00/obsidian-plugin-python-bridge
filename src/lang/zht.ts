...
export default {
  ...
  NOTICE_REFRESH_SCRIPT_SETTINGS_FAILED:
    '重新整理腳本設定定義失敗。請檢查日誌以獲取詳細資訊。',
  NOTICE_PYTHON_EXEC_MISSING_FOR_RUN:
    '無法運行腳本：找不到 Python 可執行檔。請檢查安裝和 PATH。',
