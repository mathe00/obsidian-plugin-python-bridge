...
export default {
  ...
  NOTICE_INVALID_PORT_CONFIG_SUFFIX:
    'Server nicht gestartet. Bitte konfigurieren Sie einen gültigen Port (1-65535) in den Einstellungen.',
  ...
  SETTINGS_REFRESH_DEFINITIONS_BUTTON_DESC:
    'Scannen Sie den Skriptordner erneut, um in Ihren Python-Skripten definierte Einstellungen zu entdecken oder zu aktualisieren.',
  ...
  SETTINGS_SCRIPT_FOLDER_NOT_CONFIGURED:
    'Python-Skriptordner ist nicht konfiguriert. Bitte geben Sie oben den Pfad an.',
  SETTINGS_NO_SCRIPT_SETTINGS_FOUND:
    "Keine Skripte mit definierbaren Einstellungen im konfigurierten Ordner gefunden oder die Erkennung ist fehlgeschlagen. Klicken Sie auf 'Definitionen aktualisieren', um es erneut zu versuchen.",
  ...
  SETTINGS_LANGUAGE_DESC:
    "Wählen Sie die Anzeigesprache für die Benutzeroberfläche des Python Bridge-Plugins. 'Automatisch' folgt der Spracheinstellung von Obsidian.",
  SETTINGS_BACKLINK_CACHE_RECOMMENDATION_TITLE: 'Leistungstipp: Backlink-Cache',
  SETTINGS_BACKLINK_CACHE_RECOMMENDATION_DESC:
    "Für eine verbesserte Leistung beim Abrufen von Backlinks (mit der Funktion get_backlinks) in großen Vaults sollten Sie die Installation des Community-Plugins '[Backlink Cache](https://github.com/mnaoumov/obsidian-backlink-cache)' von @mnaoumov in Betracht ziehen.",
  NOTICE_INVALID_FOLDER_PATH:
    'Ungültiger Ordnerpfad. Bitte wählen Sie einen gültigen Ordner in den Einstellungen.',
  NOTICE_INVALID_STARTUP_FOLDER_PATH:
    "Konfigurierter Python-Skript-Ordnerpfad '{path}' ist ungültig oder nicht gefunden. Einstellung wird gelöscht.",

  SETTINGS_SCRIPT_ACTIVATE_TOGGLE_NAME: 'Skript Aktiviert',
  SETTINGS_SCRIPT_ACTIVATE_TOGGLE_DESC:
    "Erlaube die Ausführung dieses Skripts über Befehle, Tastenkürzel oder 'Alle Ausführen'.",
  NOTICE_SCRIPT_DISABLED:
    "Skript '{scriptName}' ist in den Einstellungen deaktiviert und kann nicht ausgeführt werden.",

  SETTINGS_SCRIPT_AUTOSTART_TOGGLE_NAME: 'Beim Start ausführen',
  SETTINGS_SCRIPT_AUTOSTART_TOGGLE_DESC:
    "Dieses Skript automatisch ausführen, wenn Obsidian startet (nur wenn 'Skript aktiviert' ebenfalls eingeschaltet ist).",
  SETTINGS_SCRIPT_AUTOSTART_DELAY_NAME: 'Startverzögerung (Sekunden)',
  SETTINGS_SCRIPT_AUTOSTART_DELAY_DESC:
    "Warten Sie diese Anzahl von Sekunden nach dem Start von Obsidian, bevor Sie das Skript ausführen (gilt nur, wenn 'Beim Start ausführen' aktiviert ist). Verwenden Sie 0 für keine Verzögerung.",

  SETTINGS_AUTO_PYTHONPATH_NAME: 'PYTHONPATH automatisch für Bibliothek setzen',
  SETTINGS_AUTO_PYTHONPATH_DESC:
    'Fügt das Plugin-Verzeichnis beim Ausführen von Skripten automatisch zu PYTHONPATH hinzu, was den direkten Import der Python-Bibliothek ermöglicht (Empfohlen). Wenn deaktiviert, müssen Sie ObsidianPluginDevPythonToJS.py in Ihren Skriptordner kopieren oder sys.path manuell verwalten.',
  NOTICE_AUTO_PYTHONPATH_DISABLED_DESC:
    'Automatisches PYTHONPATH deaktiviert. Stellen Sie sicher, dass sich ObsidianPluginDevPythonToJS.py in Ihrem Skriptordner befindet oder verwalten Sie sys.path manuell.',
